...
syn match cupNonTerm "\<[a-z]\+\(_[a-z]\+\)\+\>" contained
syn match cupNonTermDef "^[a-z][A-Za-z]\+\>" contained
syn match cupNonTermDef "^[a-z]\+\(_[a-z]\+\)\+\>" contained
...
syn match cupDef "\<nonassoc\>" contained
...
hi link cupTerm             Field
hi link cupNonTermDef       Function
hi link cupNonTerm          Typedef
hi link cupVar              Argument
...
hi link cupResult           LocalVariable
